...
function updateCardData() {
    $.get(BattleCardDataUrl).then(function(e) {
        var t = "guid\tname\tklassType\telementType\trarityType\tturns\ttypesTargets\tbrag\tminValues\tmaxValues\ttier\tmats\tperkBase\tperks\teffects\tpacks";
        bh.Repo.mapTsv(e).map(function(e) {
            try {
                var t = e.Id,
                    r = bh.data.BattleCardRepo.find(t),
                    n = e["Effect Type"].includes("/") ? [0, 1] : [0],
                    a = {
                        guid: t,
                ...
                return r ? r.name != e.Name && console.log(r.name + " !== " + e.Name) : console.log("New Card: " + e.Name), a
            } catch (t) {
                console.error(e)
            }
            return null
            ...
            t += "\n" + e.guid + "\t" + e.name + "\t" + bh.KlassType[e.klassType].slice(0, 2) + "\t" + bh.ElementType[e.elementType][0] + "\t" + bh.RarityType[e.rarityType][0] + "\t" + e.turns + "\t" + e.typesTargets.join("|") + "\t" + String(e.brag)[0] + "\t" + e.minValues.map(function(e) {
                return e.join(",")
            }).join("|") + "\t" + e.maxValues.join("|") + "\t" + e.tier + "\t" + e.mats.join(",") + "\t" + e.perkBase + "\t" + e.perks.join(",") + "\t" + e.effects.join(",") + "\t" + String(e.inPacks)[0]
        }), $("#data-output").val(t)
    })
}

function rateCards(e) {
    void 0 === e && (e = !0);
    var t = bh.data.BattleCardRepo.all.map(function(t) {
        var r = {
            configId: t.guid
        };
        return r.evolutionLevel = e ? t.rarityType : 0, r.level = e ? bh.BattleCardRepo.getLevelsForRarity(t.rarityType) - 1 : 0, {
            card: t,
            powerRating: bh.PowerRating.ratePlayerCard(r)
        }
    });
    return t.sort(function(e, t) {
        return t.powerRating - e.powerRating
    }), $("textarea").val(t.map(function(e, t) {
        return t + 1 + ": " + e.powerRating + " - " + bh.RarityType[e.card.rarityType][0] + " " + e.card.name
    }).join("\n")), t
}! function(e) {
    var t = function() {
        function e() {
        ...
        return e.prototype.clearCache = function() {
            this._cache = {}
        }, e.prototype.fromCache = function(e, t) {
...
function(e) {
    var t = function(e) {
        ...
        return __extends(t, e), Object.defineProperty(t.prototype, "act", {
            get: function() {
                return this.data.act
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(t.prototype, "boosterElementTypes", {
            get: function() {
                return this.data.boosterElementTypes
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(t.prototype, "boosterRarities", {
            get: function() {
                return this.data.boosterRarities
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(t.prototype, "crystals", {
            get: function() {
                var e = this;
            ...
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(t.prototype, "dungeon", {
            get: function() {
            ...
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(t.prototype, "elementTypes", {
            get: function() {
                return this.data.elementTypes
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(t.prototype, "fame", {
            get: function() {
            ...
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(t.prototype, "mats", {
            get: function() {
                var e = this;
            ...
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(t.prototype, "randomMats", {
            get: function() {
                return this.data.randomMats
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(t.prototype, "runes", {
            get: function() {
                var e = this;
            ...
            enumerable: !0,
            configurable: !0
        }), t.prototype.findDrop = function(e) {
    ...
    function r(e, t) {
        var r = e.split("|"),
            ...
            u = (i + o) / 2 * n,
            s = u / t;
        return console.log([e, a, i, o, n, u, s]), {
            name: r[0],
            percent: r[1],
            percentMultiplier: n,
            min: i,
...
function(e) {
    var t, r, n, a, i, o;
    (t = e.AbilityType || (e.AbilityType = {}))[t.Trait = 0] = "Trait", t[t.Active = 1] = "Active", t[t.Passive = 2] = "Passive", (r = e.ElementType || (e.ElementType = {}))[r.Fire = 0] = "Fire", r[r.Earth = 1] = "Earth", r[r.Air = 2] = "Air", r[r.Spirit = 3] = "Spirit", r[r.Water = 4] = "Water", r[r.Neutral = 5] = "Neutral", (n = e.ItemType || (e.ItemType = {}))[n.EvoJar = 0] = "EvoJar", n[n.Crystal = 1] = "Crystal", n[n.Rune = 2] = "Rune", (a = e.KlassType || (e.KlassType = {}))[a.Magic = 0] = "Magic", a[a.Might = 1] = "Might", a[a.Skill = 2] = "Skill", (i = e.PositionType || (e.PositionType = {}))[i.Member = 0] = "Member", i[i.Elder = 1] = "Elder", i[i.CoLeader = 2] = "CoLeader", i[i.Leader = 3] = "Leader", (o = e.RarityType || (e.RarityType = {}))[o.Common = 0] = "Common", o[o.Uncommon = 1] = "Uncommon", o[o.Rare = 2] = "Rare", o[o.SuperRare = 3] = "SuperRare", o[o.Legendary = 4] = "Legendary"
}(bh || (bh = {})),
function(e) {
    var t = function() {
        return function(t, r) {
    ...
    var r = function() {
        function r(r) {
            this.reports = [];
            for (var n = r.evo, a = e.data.getMaxEvo(r.rarityType), i = n; i < a; i++) this.reports.push(new t(r, i))
        }
...
function(e) {
    var t = function() {
        ...
        return r.matchEffect = function(e) {
            ...
            get: function() {
                return function(e) {
                    ...
                    var t = (e.value || "").toUpperCase().match(/(O|D)?((?:\+|\-)?\d+(?:\.\d+)?)(T)?(%)?/),
                        r = t && "O" == t[1],
                        n = t && "D" == t[1],
                        a = t && +t[2] || 1,
                        i = t && "T" == t[3] ? e.turns : 1,
                    ...
                    return s ? u * p * d : (console.warn("no target", e), 0)
                }(this)
            },
            enumerable: !0,
            configurable: !0
            ...
            if (!e) return null;
            var t = new r(e);
            return t.effect && t || null
        }, r.parseAll = function(n) {
            var a, i, o, u, s = e.data.BattleCardRepo.find(n.configId),
                l = e.BattleCardRepo.getPerk(s, n.evolutionLevel) / 100,
                c = [];
            return s.effects.forEach(function(e) {
                var t = r.parse(e);
                if (!t) return console.error("GameEffect.parse: " + e);
                t.card = s, c.push(t)
            }), s.perks.forEach(function(e) {
                var t = r.parse(e);
                if (!t) return console.error("GameEffect.parse: " + e);
                t.card = s, t.perkMultiplier = l, c.push(t)
            }), a = c, i = s.typesTargets.map(function(t) {
                return e.PlayerBattleCard.parseTarget(t)
            }), o = i.find(function(e) {
                return "Damage" == e.type
            }), u = i.find(function(e) {
                return ["Heal", "Shield"].includes(e.type)
            }), a.slice().forEach(function(r) {
                if (["Leech", "Sap"].includes(r.effect) && (r.rawTarget = "Enemy"), "Critical" == r.effect) r.target = i[0], i.slice(1).forEach(function(e) {
                    var n = t.parse(r.raw);
                    n.target = e, a.push(n)
                });
                else if ("Splash Damage" == r.effect);
                else if ("Enemy" == r.rawTarget) r.target = o || e.PlayerBattleCard.parseTarget(u.all ? "Damage All Enemies" : "Damage Single Enemy");
                else if ("Ally" == r.rawTarget) {
                    var n = u && u.type || "Heal";
                    r.target = e.PlayerBattleCard.parseTarget((o || u).all ? n + " All Allies" : n + " Single Ally")
                } else if ("Self" == r.rawTarget) {
                    var n = u && u.type || "Heal";
                    r.target = e.PlayerBattleCard.parseTarget(n + " Self")
                } else r.target || console.warn("can't find target for " + r.effect, r.card)
            }), c
        }, r
    }();
    e.GameEffect = t
    ...
    var r = function() {
        function r(e) {
            var r = e[0],
                n = e[1],
                a = e[2];
            this.guid = r.heroGuid, this.name = r.heroName, this.elementType = r.elementType, this.klassType = r.klassType, this.trait = t(this, r), this.active = t(this, n), this.passive = t(this, a), this.lower = this.name.toLowerCase()
        }
        return Object.defineProperty(r.prototype, "abilities", {
            get: function() {
                return [this.trait, this.active, this.passive]
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(r.prototype, "allBattleCards", {
            get: function() {
                return r.filterCardsByHero(this, e.data.BattleCardRepo.all)
            },
            enumerable: !0,
            configurable: !0
        }), r.prototype.getHitPoints = function(e) {
            return r.getHitPoints(this, e)
        }, Object.defineProperty(r.prototype, "maxPowerRating", {
            get: function() {
                return e.PowerRating.rateMaxedHero(this)
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(r.prototype, "maxPowerThresholds", {
            get: function() {
                var t = this;
...
function(e) {
    var t, r = function() {
        function r(e, t, n) {
            void 0 === n && (n = null);
            var a = this;
            this.win = e, this.callbackfn = t, this._targetWindow = n, window.addEventListener("message", function(e) {
                var t = e.data || e.originalEvent && e.originalEvent.data || null;
                r.isValidMessage(t) && (a.updateActive(t), a.callbackfn(t))
            })
        }
        return Object.defineProperty(r.prototype, "targetWindow", {
            get: function() {
                ...
                return this._targetWindow || console.log("no target window: " + location.href), this._targetWindow
            },
            enumerable: !0,
            configurable: !0
        }), r.prototype.updateActive = function(e) {
            e.playerGuid !== e.action && e.sessionKey !== e.action && (r.ActivePlayerGuid && r.ActivePlayerGuid === e.playerGuid || (r.ActivePlayerGuid = e.playerGuid), r.ActiveSessionKey && r.ActiveSessionKey === e.sessionKey || (r.ActiveSessionKey = e.sessionKey))
        }, r.prototype.postMessage = function(e) {
            r.isValidMessage(e) && this.targetWindow ? (this.updateActive(e), this.targetWindow.postMessage(e, "*")) : this.targetWindow ? console.log("invalid message: " + (e && e.action || "[no message]")) : console.log("no target window: " + (e && e.action || "[no message]"))
        }, r.isValidMessage = function(e) {
            if (!e) return !1;
            var t = Object.keys(e);
            return t.includes("action") && t.includes("playerGuid") && t.includes("sessionKey") && t.includes("data")
        }, r.createMessage = function(e, t) {
            return {
                action: e,
                playerGuid: r.ActivePlayerGuid,
                sessionKey: r.ActiveSessionKey,
                data: t
            }
        }, r.initialize = function(e, n) {
            return t = new r(e, n)
...
function(e) {
    ...
    var r = function(r) {
        function n(t, n) {
            ...
            return a.isArena = n, e.data.isPlayer(t) && (a._pp = t), e.data.isGuildPlayer(t) && (a._gp = t), a
        }
        return __extends(n, r), Object.defineProperty(n.prototype, "fameLevel", {
            get: function() {
                return (this._pp && this._pp.fameLevel || this._gp.fameLevel) + 1
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(n.prototype, "fragments", {
            get: function() {
                return this._pp && this._pp.fragments || 0
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(n.prototype, "fragmentsRowHtml", {
            get: function() {
                return this._pp ? t("misc", "Fragments", "Fragments", this.fragments) : ""
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(n.prototype, "gems", {
            get: function() {
                return this._pp && this._pp.gems || 0
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(n.prototype, "gemsRowHtml", {
            get: function() {
                return this._pp ? t("misc", "GemStone", "Gems", this.gems) : ""
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(n.prototype, "gold", {
            get: function() {
                return this._pp && this._pp.gold || 0
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(n.prototype, "goldNeeded", {
            get: function() {
                var e = this;
                return this.fromCache("goldNeeded", function() {
                    ...
                    return e.activeBattleCards.forEach(function(e) {
                        ...
                        return t += e ? e.trait.maxGoldCost + e.active.maxGoldCost + e.passive.maxGoldCost : 0
                    }), t
                })
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(n.prototype, "goldRowHtml", {
            get: function() {
                var r = this.goldNeeded,
                    n = r ? e.utils.formatNumber(this.gold) + " / " + e.utils.formatNumber(Math.abs(r)) + "<sup>*</sup>" : e.utils.formatNumber(this.gold);
                return this._pp ? t("misc", "Coin", "Gold", n) : ""
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(n.prototype, "guid", {
            get: function() {
                return this._pp && this._pp.id || this._gp.playerId
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(n.prototype, "guild", {
            get: function() {
                return e.data.guilds.findByGuid(this.guildGuid)
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(n.prototype, "guildGuid", {
            get: function() {
                return this._pp ? this._pp.playerGuild || null : this._gp && this._gp.guildId || null
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(n.prototype, "guildParent", {
            get: function() {
                var t = e.data.guilds.findNameByGuid(this.guildGuid);
                return t && t.parent || null
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(n.prototype, "guilds", {
            get: function() {
                var t = this,
                    r = this.fromCache("guilds", function() {
                        return e.data.guilds.filterNamesByParent(t.guildParent)
                    });
                if (!r.length) {
                    var n = e.data.guilds.findNameByGuid(this.guildGuid);
                    n && r.push(n)
                }
                return r
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(n.prototype, "heroes", {
            get: function() {
                var t = this;
                return this.fromCache("heroes", function() {
                    return (t._pp ? e.data.HeroRepo.all.map(function(r) {
            ...
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(n.prototype, "isAlly", {
            get: function() {
                var e = this;
                return this.fromCache("isAlly", function() {
                    return !!(n.me && n.me.guilds || []).find(function(t) {
                        return t.guid == e.guildGuid
                    })
                })
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(n.prototype, "canScout", {
            get: function() {
                return "b0a8b57b-54f5-47d8-8b7a-f9dac8300ca0" == this.guid
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(n.prototype, "completionPercent", {
            get: function() {
            ...
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(n.prototype, "isExtended", {
            get: function() {
                return !!this._pp
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(n.prototype, "isFullMeat", {
            get: function() {
            ...
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(n.prototype, "isMe", {
            get: function() {
            ...
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(n.prototype, "powerRating", {
            get: function() {
                var e = this;
                return this.fromCache("poewrRating", function() {
            ...
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(n.prototype, "raidRowHtml", {
            get: function() {
                return this._pp ? t("keys", "RaidTicket", "Raid Tickets", this.raidTickets) : ""
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(n.prototype, "raidTickets", {
            get: function() {
                return this._pp && this._pp.raidKeys || 0
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(n.prototype, "battleCards", {
            get: function() {
                var e = this;
            ...
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(n.prototype, "activeBattleCards", {
            get: function() {
                var e = this;
            ...
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(n.prototype, "activeRecipes", {
            get: function() {
                var t = this;
            ...
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(n.prototype, "boosterCards", {
            get: function() {
            ...
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(n.prototype, "boosterCount", {
            get: function() {
                var e = 0,
            ...
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(n.prototype, "boosterRowHtml", {
            get: function() {
                return this._pp ? e.PlayerBoosterCard.rowHtml(this.boosterCount) : ""
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(n.prototype, "inventory", {
            get: function() {
                var t = this,
            ...
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(n.prototype, "wildCards", {
            get: function() {
                var t = this;
            ...
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(n.prototype, "wildCardRowHtml", {
            get: function() {
            ...
            enumerable: !0,
            configurable: !0
        }), n.prototype.battleCardToPlayerBattleInfo = function(t) {
            var r = this._pp.playerCards.cards[t];
            return new e.PlayerBattleCard(r)
        }, n.prototype.filterActiveBattleCards = function() {
            for (var t, r, n, a, i = [], o = 0; o < arguments.length; o++) i[o] = arguments[o];
            return i.forEach(function(a) {
                return e.ElementRepo.isElement(a) ? t = a : e.RarityRepo.isRarity(a) ? r = a : n = a
            }), n && (a = e.data.HeroRepo.find(n)), this.activeBattleCards.filter(function(e) {
                return e.matchesElement(t) && e.matchesRarity(r) && e.matchesHero(a)
            })
        }, n.prototype.filterHeroes = function(t) {
            var r = e.ElementRepo.isElement(t) ? t : null,
                n = r ? null : t;
            return this.heroes.filter(function(t) {
                return t && (r && e.ElementType[t.elementType] == r || n && t.name == n)
            })
        }, n.prototype.findPlayerCard = function(e) {
            var t = this._pp && this._pp.playerCards.cards,
                r = t && t[e];
            if (!r && t) {
                var n = Object.keys(t).find(function(r) {
        ...
        }, n.prototype.sortAndReduceBattleCards = function(t) {
            var r = this,
                n = [];
            return t.map(function(e) {
                return r.battleCardToPlayerBattleInfo(e)
            }).sort(e.utils.sort.byRarityThenNameThenEvoLevel).forEach(function(e) {
...
function(e) {
    var t = function() {
        ...
        return t.prototype._rowChildren = function() {
            var t = this,
                r = "";
            if (!this.isUnknown) {
                var n = e.Player.me,
                ...
                if (a) {
                    var i = e.data.calcMaxGoldNeeded(this.playerCard, this.evoLevel) * this.count,
                        o = n.gold,
                        u = o < i ? "bg-danger" : "bg-success";
                    r += "<div>" + e.getImg20("misc", "Coin") + ' Gold <span class="badge pull-right ' + u + '">' + e.utils.formatNumber(o) + " / " + e.utils.formatNumber(i) + "</span></div>", a.all.forEach(function(a) {
                        if (a.max) {
                            var i = a.item,
                                o = i.guid,
                                u = n.inventory.find(function(e) {
                                    return e.guid == o
                                }),
                                s = u && u.count || 0;
                            r += e.PlayerInventoryItem.toRowHtml(i, s, a.max * t.count)
                        }
                    });
                    var s = e.data.getMaxWildCardsNeeded(this) * this.count,
                        l = n.wildCards[this.rarityType],
                        c = !l && e.data.WildCardRepo.find(e.RarityType[this.rarityType]) || null,
                        d = l && n.wildCards[this.rarityType].count || 0;
                    r += e.PlayerWildCard.toRowHtml(l || c, d, s);
                    var p = e.data.calcMaxRunesNeeded(this.playerCard, this.evoLevel),
                        f = n.inventory.find(function(r) {
                            return r.isRune && t.matchesHero(e.data.HeroRepo.find(r.name.split("'")[0]))
                        }),
                        y = f && f.count || 0;
                    p && f && (r += e.PlayerInventoryItem.toRowHtml(f, y, p));
                    var g = e.data.calcMaxCrystalsNeeded(this.playerCard, this.evoLevel),
                        h = n.inventory.find(function(e) {
                            return e.isCrystal && t.elementType == e.elementType
                        }),
                        m = h && h.count || 0;
                    g && h && (r += e.PlayerInventoryItem.toRowHtml(h, m, g))
                }
            }
            return r
        }, t.prototype._rowHtml = function(t, r) {
        ...
        }, Object.defineProperty(t.prototype, "brag", {
            get: function() {
            ...
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(t.prototype, "inPacks", {
            get: function() {
                return this._bc && this._bc.inPacks || !1
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(t.prototype, "klassType", {
            get: function() {
            ...
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(t.prototype, "maxValues", {
            get: function() {
                return this._bc && this._bc.maxValues || []
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(t.prototype, "minValues", {
            get: function() {
            ...
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(t.prototype, "isOp", {
            get: function() {
                return this._bc && this._bc.isOp || !1
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(t.prototype, "perkBase", {
            get: function() {
                return this._bc && this._bc.perkBase || 0
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(t.prototype, "perks", {
            get: function() {
            ...
            get: function() {
                return this.typesTargets.map(function(e) {
                    ...
                    return i ? "Self" : n ? "Single" : r ? "Multi" : a ? "Splash" : (console.log('Target of "' + e + '"'), e)
                })
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(t.prototype, "turns", {
            get: function() {
                return this._bc && this._bc.turns || 0
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(t.prototype, "tier", {
            get: function() {
                return this._bc && this._bc.tier || null
            },
            enumerable: !0,
            configurable: !0
            ...
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(t.prototype, "typesTargets", {
            get: function() {
                return this._bc && this._bc.typesTargets || []
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(t.prototype, "evo", {
            get: function() {
            ...
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(t.prototype, "battleOrBragImage", {
            get: function() {
                return e.getImg20("cardtypes", this.brag ? "Brag" : "BattleCard")
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(t.prototype, "evoLevel", {
            get: function() {
                return this.evo + "." + ("0" + this.level).slice(-2)
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(t.prototype, "formattedValue", {
            get: function() {
                return this.value ? e.utils.formatNumber(this.value) : ""
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(t.prototype, "fullHtml", {
            get: function() {
            ...
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(t.prototype, "rarityEvoLevel", {
            get: function() {
            ...
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(t.prototype, "scoutHtml", {
            get: function() {
                return this.rarityEvoLevel + " " + this.name + " " + (this.count > 1 ? "x" + this.count : "")
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(t.prototype, "typeImage", {
            get: function() {
            ...
            get: function() {
                return this.playerCard && e.BattleCardRepo.calculateValue(this.playerCard) || 0
            },
            enumerable: !0,
            configurable: !0
            ...
            return {
                ...
                single: s,
                self: u,
                targetMultiplier: i ? a ? 3 : 2 : o ? a ? 2 : 1.5 : s ? a ? 1 : 1.25 : u ? 1 : 0,
                flurry: !!l,
                flurryCount: c,
                flurryHitPercent: d,
...
function(e) {
    ...
    var r = function(r) {
        function n(t, n) {
            var a = r.call(this) || this;
            return a.player = t, a.archetype = n, a.hero = e.data.HeroRepo.find(n.id), a
        }
        return __extends(n, r), n.prototype.getAbilityLevel = function(e) {
            var t = this.archetype.abilityLevels ? this.archetype.abilityLevels[this.hero.abilities[e].guid] : null;
            return isNaN(t) ? 0 : t + 1
        }, Object.defineProperty(n.prototype, "abilities", {
            get: function() {
                return this.hero.abilities
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(n.prototype, "abilityLevels", {
            get: function() {
            ...
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(n.prototype, "elementType", {
            get: function() {
                return this.hero.elementType
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(n.prototype, "klassType", {
            get: function() {
            ...
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(n.prototype, "passive", {
            get: function() {
                var r = this;
            ...
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(n.prototype, "trait", {
            get: function() {
                var r = this;
            ...
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(n.prototype, "completionLevel", {
            get: function() {
                return this.level + this.trait.level + this.active.level + this.passive.level
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(n.prototype, "deck", {
            get: function() {
                var e = this;
            ...
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(n.prototype, "hitPoints", {
            get: function() {
                return this.hero.getHitPoints(this.level)
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(n.prototype, "isCapped", {
            get: function() {
            ...
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(n.prototype, "isMeat", {
            get: function() {
            ...
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(n.prototype, "isOp", {
            get: function() {
                return !!this.deck.find(function(e) {
                    return "OP" == e.tier
                })
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(n.prototype, "playerHeroAbilities", {
            get: function() {
                return [this.trait, this.active, this.passive]
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(n.prototype, "playerHeroGuid", {
            get: function() {
                return this.player.guid + "-" + this.hero.guid
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(n.prototype, "powerPercent", {
            get: function() {
...
function(e) {
    function t(t, r) {
        switch (t) {
            case e.AbilityType.Trait:
                return (i = r) < 2 ? 1 : i < 10 ? 2 : i < 18 ? 3 : i < 25 ? 4 : i < 33 ? 5 : i < 41 ? 6 : i < 49 ? 7 : i < 56 ? 8 : i < 64 ? 9 : i < 72 ? 10 : i < 80 ? 11 : i < 87 ? 12 : i < 95 ? 13 : i < 103 ? 14 : 15;
            case e.AbilityType.Active:
                return (a = r) < 2 ? 1 : a < 7 ? 3 : a < 13 ? 4 : a < 18 ? 5 : a < 23 ? 6 : a < 28 ? 7 : a < 33 ? 8 : a < 38 ? 9 : a < 43 ? 10 : a < 48 ? 11 : a < 53 ? 12 : a < 58 ? 13 : a < 63 ? 14 : a < 68 ? 15 : a < 73 ? 16 : a < 78 ? 17 : a < 83 ? 18 : 19;
            case e.AbilityType.Passive:
                return (n = r) < 2 ? 2 : n < 6 ? 4 : n < 9 ? 5 : n < 12 ? 6 : n < 16 ? 7 : n < 19 ? 8 : n < 22 ? 9 : n < 26 ? 10 : n < 29 ? 11 : n < 32 ? 12 : n < 36 ? 13 : n < 39 ? 14 : n < 42 ? 15 : n < 46 ? 16 : n < 49 ? 17 : n < 52 ? 18 : n < 56 ? 19 : n < 59 ? 20 : n < 62 ? 21 : n < 66 ? 22 : 23
        }
        var n, a, i
    }

    function r(e, r, n) {
        for (var a = 0, i = r + 1, o = n + 1; i < o; i++) a += t(e, i);
        return a
    }
    ...
    function n(t, r) {
        switch (t) {
            case e.AbilityType.Trait:
                return function(e) {
                    if (1 == e) return 1e3;
                    for (var t = 754, r = 3e3, n = 2; n < e; n++) r += t, t += 8;
                    return r
                }(r);
            case e.AbilityType.Active:
                return function(e) {
                    if (1 == e) return 5e3;
                    for (var t = 510, r = 3500, n = 2; n < e; n++) r += t, t += 20;
                    return r
                }(r);
            case e.AbilityType.Passive:
                return function(e) {
                    if (1 == e) return 7e3;
                    for (var t = 1015, r = 1e4, n = 2; n < e; n++) r += t, t += 30;
                    return r
                }(r)
        }
    }
    ...
    function a(e, t, r) {
        for (var a = 0, i = t + 1, o = r + 1; i < o; i++) a += n(e, i);
        return a
    }
    e.getMaterialCountFor = t, e.getMaterialCountForRange = r, e.getGoldCostFor = n, e.getGoldCostForRange = a;
    var i = function() {
        function i(e, t, r) {
            this.playerHero = e, this.heroAbility = t, this.level = r
        }
        return Object.defineProperty(i.prototype, "_type", {
            get: function() {
            ...
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(i.prototype, "hero", {
            get: function() {
                return this.heroAbility.hero
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(i.prototype, "guid", {
            get: function() {
            ...
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(i.prototype, "isCapped", {
            get: function() {
                return this.level == this.levelCap
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(i.prototype, "isMaxed", {
            get: function() {
                return this.level == this.levelMax
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(i.prototype, "levelCap", {
            get: function() {
                return e.HeroRepo.getAbilityLevelCap(this)
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(i.prototype, "levelMax", {
            get: function() {
                return e.HeroRepo.getAbilityLevelMax(this)
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(i.prototype, "nextMaterialCount", {
            get: function() {
                return t(this._type, this.level + 1)
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(i.prototype, "maxMaterialCount", {
            get: function() {
                var t = this._type,
                    n = e.HeroRepo.getAbilityMaxLevel(this.hero, this.heroAbility.type);
                return r(t, this.level, n)
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(i.prototype, "nextGoldCost", {
            get: function() {
                return n(this._type, this.level + 1)
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(i.prototype, "maxGoldCost", {
            get: function() {
                this._type;
                var t = e.HeroRepo.getAbilityMaxLevel(this.hero, this.heroAbility.type);
                return a(this._type, this.level, t)
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(i.prototype, "img", {
            get: function() {
                return e.getImg("skills", this.playerHero.name + e.AbilityType[this.type])
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(i.prototype, "materialHtml", {
            get: function() {
                var t = this,
            ...
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(i.prototype, "goldHtml", {
            get: function() {
            ...
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(i.prototype, "powerRating", {
            get: function() {
                return e.PowerRating.ratePlayerHeroAbility(this)
            },
            enumerable: !0,
            configurable: !0
        }), i.prototype.toRowHtml = function(t, r) {
            var n = "number" == typeof t ? '<span class="badge pull-right ' + (t && r ? r < t ? "bg-danger" : "bg-success" : "") + '">' + e.utils.formatNumber(t) + "</span>" : "";
            return "<div>" + this.img + " " + this.playerHero.name + " " + e.AbilityType[this.type] + " " + n + "</div>"
        }, i
    }();
    e.PlayerHeroAbility = i
}(bh || (bh = {})),
function(e) {
    var t = function() {
        function t(e, t, r) {
        ...
        return Object.defineProperty(t.prototype, "elementType", {
            ...
            get: function() {
                var t = this,
                    ...
                    i = e.getImg20(n, a),
                    o = this.needed,
                    u = o ? " / " + e.utils.formatNumber(o) : "",
                    s = '<span class="badge pull-right ' + (o ? this.count < o ? "bg-danger" : "bg-success" : "") + '">' + e.utils.formatNumber(this.count) + u + "</span>",
                    l = "";
                if (o)
                    if (this.isCrystal) this.player.filterHeroes(e.ElementType[this.elementType]).forEach(function(e) {
                        var r, n, a = e.active,
                            i = e.passive;
                        (r = a.maxMaterialCount) && (l += a.toRowHtml(r, t.count)), (n = i.maxMaterialCount) && (l += i.toRowHtml(n, t.count))
                    ...
                    e.maxMaxSotNeeded;
                    l += e.toRowHtml(e.maxMaxSotNeeded, t.count)
                });
                else {
                    this.player.activeRecipes.filter(function(e) {
                        var r = e.getItem(t);
                        ...
                        l += e.card.toRowHtml(r, t.count)
                    })
                }
                return '<div data-element-type="' + this.elementType + '" data-rarity-type="' + this.rarityType + '" data-item-type="' + this.itemType + '" data-hud="' + this.isSandsOfTime + '">' + r(this.guid, i + " " + this.name + " " + s, l) + "</div>"
            },
            enumerable: !0,
            configurable: !0
            ...
            var i = e.ItemType[r.itemType].toLowerCase() + "s",
                ...
                u = e.getImg20(i, o),
                s = '<span class="badge pull-right ' + (n < a ? "bg-danger" : "bg-success") + '">' + e.utils.formatNumber(n) + " / " + e.utils.formatNumber(a) + "</span>";
            return "<div>" + u + " " + r.name + " " + s + "</div>"
        }, t
    }();
        ...
        return Object.defineProperty(t.prototype, "count", {
            ...
            get: function() {
                var t = this.needed,
                    ...
                    n = '<span class="badge pull-right ' + (t ? this.count < t ? "bg-danger" : "bg-success" : "") + '">' + this.count + r + "</span>";
                return e.getImg("cardtypes", "WildCard") + " " + this.name + " WC " + n
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(t.prototype, "name", {
            ...
            var a = e.getImg20("cardtypes", "WildCard"),
                i = '<span class="badge pull-right ' + (r < n ? "bg-danger" : "bg-success") + '">' + e.utils.formatNumber(r) + " / " + e.utils.formatNumber(n) + "</span>";
            return "<div>" + a + " " + t.name + " WC " + i + "</div>"
        }, t
    }();
    e.PlayerWildCard = t
}(bh || (bh = {})),
function(e) {
    ...
    (r = t = e.MinMaxType || (e.MinMaxType = {}))[r.Min = 0] = "Min", r[r.Max = 1] = "Max";
    var i = function() {
        function r() {}
        return r.rateMaxedHero = function(t, n) {
            return void 0 === n && (n = e.RarityType.Legendary), ("Jinx" == t.name ? 45 : 55) * (20 * (n + 1) / 100) + r.rateMaxedDeck(t, n)
        }, r.rateMaxedDeck = function(n, a) {
            void 0 === a && (a = e.RarityType.Legendary);
            var i = [];
            return e.Hero.filterCardsByHero(n, e.data.BattleCardRepo.all).filter(function(e) {
                return e.rarityType <= a
            }).map(function(e) {
                return {
                    card: e,
                    powerRating: r.rateBattleCard(e, t.Max)
                }
            }).sort(function(e, t) {
                ...
                r ? r.card.rarityType == e.RarityType.SuperRare && t.card.rarityType == e.RarityType.Legendary && (i = i.filter(function(e) {
                    return e != r
                })).push(t) : i.length < 4 && i.push(t)
            }), i.reduce(function(e, t) {
                return e + 2 * t.powerRating
            }, 0)
        }, r.rateDeck = function(t) {
            t.reduce(function(e, t) {
                return e[t.playerCard.configId] = r.ratePlayerCard(t.playerCard), e
            }, {});
            var n = t.filter(function(t) {
                return e.BattleCardRepo.isCycleCard(t, t.evo)
            });
            n.length, t.filter(function(e) {
                return !n.includes(e)
            });
            return t.reduce(function(e, t) {
                return e + r.ratePlayerCard(t.playerCard) * t.count
            }, 0)
        }, r.rateBattleCard = function(i, o) {
            var u = e.RarityType[i.rarityType],
                s = o == t.Max ? n[u] : 0,
                l = o == t.Max ? a[u] : 0;
            return r.ratePlayerCard({
                configId: i.guid,
                evolutionLevel: s,
                level: l - 1
            })
        }, r.rateAndSort = function(e, n) {
            void 0 === n && (n = t.Max);
            var a = e.map(function(e) {
                return {
                    card: e,
                    powerRating: r.rateBattleCard(e, n)
                }
            });
            return a.sort(function(e, t) {
                return t.powerRating - e.powerRating
            }), a
        }, r.ratePlayerCard = function(t) {
            return function(t) {
                if (!t) return 0;
                ...
                var n = t.evolutionLevel,
                    a = t.level,
                    i = (e.BattleCardRepo.getPerk(r, n), r.typesTargets.map(function(t) {
                        return e.PlayerBattleCard.parseTarget(t)
                    })),
                    o = e.GameEffect.parseAll(t),
                    u = 0;
                return i.forEach(function(t, i) {
                    return u += function(t, r, n, a) {
                        if (!t) return 0;
                        var i = e.BattleCardRepo.calculateValue({
                                configId: t.guid,
                                evolutionLevel: n,
                                level: a
                            }),
                            o = e.BattleCardRepo.getPerk(t, n) / 100,
                            u = (e.GameEffect.parse(t.effects.find(function(e) {
                                return "Regen" == e
                            })) || {
                                turns: 1
                            }).turns,
                            s = t.perks.includes("Critical") ? 1.5 * o : 1,
                            l = e.PlayerBattleCard.parseTarget(t.typesTargets[r]),
                            c = Math.round(i * s * l.targetMultiplier * u);
                        return l.flurry && (c = c / l.flurryCount * l.flurryHitMultiplier * l.flurryCount), c || console.log(t.name, [t, r, n, a, i, o, s, l, c]), c
                    }(r, i, n, a) / t.typeDivisor
                }), o.forEach(function(e) {
                    return u += e.powerRating
                }), u /= r.turns, Math.round(100 * u)
            }(t)
        }, r.ratePlayerHeroAbility = function(t) {
        ...
        }, r.ratePlayerHeroHitPoints = function(t) {
...
function(e) {
    var t = function(t) {
        function r(r, n) {
            ...
            a.card = r, a.evos = [];
            var i = (r && r.mats || []).map(function(t) {
                return e.data.ItemRepo.find(t.trim())
            }).filter(function(e) {
                return !!e
            }).sort(e.utils.sort.byRarity);
            return [0, 1, 2, 3, 4].slice(0, r.rarityType + 1).slice(n ? r.evo : 0).forEach(function(t) {
                var n = e.ItemRepo.sandsOfTime;
                a.addItem(t, e.data.getMinSotNeeded(r.rarityType, t), e.data.getMaxSotNeeded(r.rarityType, t), n.name), i.forEach(function(n) {
                    a.addItem(t, 0, e.data.getMaxMatNeeded(r.rarityType, t, n.rarityType), n.name)
                })
            }), a
        }
        return __extends(r, t), Object.defineProperty(r.prototype, "lower", {
            get: function() {
            ...
            enumerable: !0,
            configurable: !0
        }), r.prototype.addItem = function(t, r, n, a) {
            ...
            i.items.push(o)
        }, Object.defineProperty(r.prototype, "common", {
            get: function() {
                var t = this;
            ...
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(r.prototype, "uncommon", {
            get: function() {
                var t = this;
            ...
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(r.prototype, "rare", {
            get: function() {
                var t = this;
            ...
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(r.prototype, "superRare", {
            get: function() {
                var t = this;
            ...
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(r.prototype, "inventoryItems", {
            get: function() {
        ...
        }, r.prototype.getMaxNeeded = function(t) {
...
function(e) {
    var t = function() {
        function t(e, r, n) {
            void 0 === e && (e = ""), void 0 === r && (r = 0), void 0 === n && (n = !1), this.id = e, this.gid = r, this.cacheable = n, t.AllRepos.push(this)
        }
        return t.prototype.init = function() {
        ...
        }, t.prototype.resolveTsv = function(t, r) {
            var n = this;
        ...
        }, t.prototype.unresolveTsv = function() {
            this.data = []
        }, t.prototype.parseTsv = function(e) {
            ...
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(t.prototype, "allSortedByName", {
            get: function() {
        ...
        }, t.fetchTsv = function(t, r) {
            var n = "number" == typeof r ? t : null,
                a = "number" == typeof r ? r : t;
            return (e.TSV || {})[String(a)] ? Promise.resolve(e.TSV[String(a)]) : XmlHttpRequest.get(e.host + "/tsv.php?gid=" + a + (n ? "&id=" + n : ""))
        }, t.mapTsv = function(t) {
            var r = t.split(/\n/),
            ...
            return t.AllRepos.map(function(e) {
                return e.init()
            })
        }, t.AllRepos = [], t
    }();
...
! function(e) {
    var t = function(t) {
        ...
        return __extends(r, t), r.isCycleCard = function(t, n) {
            return !!t && (void 0 === n && (n = t.rarityType + 1), t.effects.concat(t.perks).filter(function(e) {
                return e.toLowerCase().includes("haste") || e.toLowerCase().includes("speed")
            }).forEach(function(r) {
                return _allHastes.push(t.name + " (" + e.RarityType[t.rarityType][0] + "): " + r)
            }), 1 == t.turns && (!!t.effects.find(function(e) {
                return "Haste 1T" == e
            }) || !(!t.perks.find(function(e) {
                return "Haste 1T" == e
            }) || 100 != r.getPerk(t, n))))
        }, r.getPerk = function(e, t) {
            return e ? Math.min(100, e.perkBase + r.AddedPerkPerEvo * t) : 0
        }, r.getMaxPerk = function(e) {
            return e ? r.getPerk(e, 1 + e.rarityType) : 0
        }, r.calculateValue = function(t, r) {
            if (!t) return 0;
            void 0 === r && (r = 0);
            var n = e.data.BattleCardRepo.find(t.configId);
            if (!n) return 0;
            var a = n.minValues[r][t.evolutionLevel],
                i = n.minValues[r].slice().pop(),
                o = (n.maxValues[r] - i) / (e.BattleCardRepo.getLevelsForRarity(n.rarityType) - 1);
            return Math.floor(a + o * t.level)
        }, r.getLevelsForRarity = function(e) {
            return [10, 20, 35, 50, 50][e]
        }, r.isMaxLevel = function(t, n) {
            return n == r.getLevelsForRarity(e.RarityRepo.findType(t))
        }, r.getXpDeltaFromLevel = function(e) {
            return e ? 36 * (e - 1) + 100 : 0
        }, r.getXpForLevel = function(e) {
            for (var t = 0, n = 1; n < e; n++) t += r.getXpDeltaFromLevel(n);
            return t
        }, r.getXpValue = function(t) {
            switch (t.rarityType) {
...
function(e) {
    var t = function(t) {
        ...
        return __extends(r, t), r.getXpValue = function(t, r) {
            void 0 === r && (r = !1);
            var n = r ? 1.5 : 1;
            switch (t.rarityType) {
                case e.RarityType.Common:
...
function(e) {
    var t = function(t) {
        ...
        return __extends(n, t), n.prototype.parseTsv = function(t) {
        ...
        }, n.prototype.findDungeonFor = function(e) {
            return this.all.filter(function(t) {
                return !!t.findDrop(e)
            })
        }, n.prototype.getDropRates = function(e) {
    ...
    function r(e, t) {
        ...
        var o = "Normal" == e.dungeon.difficulty ? 0 : "Elite" == e.dungeon.difficulty ? 1 : 2,
            u = "Normal" == t.dungeon.difficulty ? 0 : "Elite" == t.dungeon.difficulty ? 1 : 2;
        return o != u ? o < u ? 1 : -1 : 0
    }
    e.DungeonRepo = t
}(bh || (bh = {})),
function(e) {
...
function(e) {
    var t = function(t) {
        ...
        return __extends(r, t), r.prototype.parseTsv = function(t) {
            var r = this;
            return new Promise(function(n) {
                for (var a = e.Repo.mapTsv(t), i = []; a.length;) i.push(new e.Hero([a.shift(), a.shift(), a.shift()]));
                n(r.data = i)
            })
        }, r.prototype.filterByElement = function(t) {
            return this.data.filter(function(r) {
                return r.elementType === t || e.ElementType[r.elementType] === t
            })
        }, Object.defineProperty(r.prototype, "sorted", {
            get: function() {
                return this._sorted || (this._sorted = this.data.slice().sort(e.utils.sort.byElementThenKlass)), this._sorted
            },
            enumerable: !0,
            configurable: !0
        }), r.prototype.sortBy = function(e) {
            return e ? this.data.slice().sort(e) : this.sorted
        }, r.toImageSrc = function(t) {
            return e.getSrc("heroes", t.name)
        }, r.getMaxLevel = function(e) {
            return 2 * e
        }, r.getMaxTrait = function(e) {
            return Math.max(e - 1, 0)
        }, r.getMaxActive = function(e, t) {
            return "Jinx" == e.name ? Math.max(t - 29, 0) : Math.max(t - 14, 0)
        }, r.getMaxPassive = function(e, t) {
            return "Jinx" == e.name ? Math.max(t - 14, 0) : Math.max(t - 29, 0)
        }, r.getAbilityLevelCap = function(t) {
            switch (t.type) {
                case e.AbilityType.Active:
                    return r.getMaxActive(t.hero, t.playerHero.level);
                case e.AbilityType.Passive:
                    return r.getMaxPassive(t.hero, t.playerHero.level);
                case e.AbilityType.Trait:
                    return r.getMaxTrait(t.playerHero.level)
            }
        }, r.getAbilityLevelMax = function(t) {
            switch (t.type) {
                case e.AbilityType.Active:
                    return r.getMaxActive(t.hero, r.MaxLevel);
                case e.AbilityType.Passive:
                    return r.getMaxPassive(t.hero, r.MaxLevel);
                case e.AbilityType.Trait:
                    return r.getMaxTrait(r.MaxLevel)
            }
        }, Object.defineProperty(r, "MaxHeroCount", {
            get: function() {
                return MaxHeroCount
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(r, "MaxFame", {
            get: function() {
                return MaxFameLevel
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(r, "MaxLevel", {
            get: function() {
                return r.getMaxLevel(r.MaxFame)
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(r, "MaxCompletionLevel", {
            get: function() {
                var e = r.MaxLevel,
                    t = {};
                return e + r.getMaxTrait(e) + r.getMaxActive(t, e) + r.getMaxPassive(t, e)
            },
            enumerable: !0,
            configurable: !0
        }), r.getAbilityMaxLevel = function(t, n) {
            switch (n) {
                case e.AbilityType.Active:
                    return r.getMaxActive(t, r.MaxLevel);
                case e.AbilityType.Passive:
                    return r.getMaxPassive(t, r.MaxLevel);
                case e.AbilityType.Trait:
                    return r.getMaxTrait(r.MaxLevel)
            }
        }, r.getLockedArchetype = function(e, t) {
            return {
                playerId: e,
                id: t,
                experience: 0,
...
function(e) {
    var t = function(t) {
        ...
        return __extends(r, t), Object.defineProperty(r.prototype, "evoJars", {
            get: function() {
            ...
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(r.prototype, "crystals", {
            get: function() {
                return this.data.filter(function(t) {
            ...
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(r.prototype, "runes", {
            get: function() {
                return this.data.filter(function(t) {
            ...
            enumerable: !0,
            configurable: !0
        }), r.getValue = function(t, r) {
            return t == e.ItemType.Crystal ? 1e3 : t == e.ItemType.Rune ? 2e3 : [300, 800, 1500, 3e3][r]
        }, Object.defineProperty(r, "sandsOfTime", {
            get: function() {
                return e.data.ItemRepo.find("Sands of Time")
            },
            enumerable: !0,
            configurable: !0
        }), r.toImage = function(t, r) {
            ...
            return e.getSrc(r, n)
        }, Object.defineProperty(r, "allTypes", {
            get: function() {
                return [0, 1, 2]
            },
            enumerable: !0,
            configurable: !0
        }), r.findType = function(t) {
            return this.allTypes.find(function(r) {
...
var bh, DataSheetID = "1203v6egra6rDQShMdklVHQrPa7lfP6RaSCcqdATIEIo",
    BattleCardRepoGID = 1013492615,
    BoosterCardRepoGID = 1070164839,
    DungeonRepoGID = 1980099142,
    EffectRepoGID = 1091073205,
    HeroRepoGID = 1755919442,
    ItemRepoGID = 1250310062,
    WildCardRepoGID = 2106503523,
    GuildsGID = 496437953,
    USE_CACHE = !0,
    NO_CACHE = !1,
    MaxHeroCount = 13,
    ...
    ShieldDivisor = 1500,
    HealDivisor = 1500,
    BattleCardDataUrl = "https://docs.google.com/spreadsheets/d/e/2PACX-1vQgpt5tf178r4MJku64wjcQyK-py5KTwbeoePP4vnFQ0gEJWowglA-cGHLSQtVbpp7kb_07gLbZP1N_/pub?output=tsv",
    DungeonDataUrl = "https://docs.google.com/spreadsheets/d/e/2PACX-1vRCyjBTeKjsBri_uvkFnT-i9f-jI4RUR0YffYh32XFtQfywivXktmLcmGOuXTfOQZH1sv6VTmF9Ceee/pub?gid=1815567292&single=true&output=tsv";

function numToRoman(e) {
    switch (+e) {
        case 1:
            return "I";
        case 2:
...
function updateDungeonData() {
    $.get(DungeonDataUrl).then(function(e) {
        var t = bh.Repo.mapTsv(e),
            r = Object.keys(t[0]),
            n = t.map(function(e) {
                var t = e.Dungeon + " " + e.Difficulty + " " + numToRoman(e.Level),
                    r = bh.data.DungeonRepo.find(t).data;
                return r || ((r = {}).guid = t.replace(/\W/g, "-"), r.name = t, r.dungeon = e.Dungeon, r.difficulty = e.Difficulty, r.act = numToRoman(e.Level), r.keys = -1, r.fame = -1, r.gold = -1, r.elementTypes = [], r.crystals = [], r.runes = [], r.mats = [], r.randomMats = [], r.boosterElementTypes = [], r.boosterRarities = []), r.keys = +e.Keys, r.crystals = bh.data.ItemRepo.crystals.filter(function(t) {
                    return !!e[t.name]
                }).map(function(t) {
                    return t.name.split(/\W/)[0] + "|" + e[t.name].replace(/\s+/g, "").replace(",", "|")
                }), r.mats = bh.data.ItemRepo.evoJars.filter(function(t) {
                    return !!e[t.name]
                }).map(function(t) {
                    return t.name + "|" + e[t.name].replace(/\s+/g, "").replace(",", "|")
                }), r.runes = bh.data.ItemRepo.runes.filter(function(t) {
                    return !!e[t.name.startsWith("Hawk") ? "Hawkeye Air Rune" : t.name]
                }).map(function(t) {
                    return t.name.split(/\W/)[0] + "|" + e[t.name.startsWith("Hawk") ? "Hawkeye Air Rune" : t.name].replace(/\s+/g, "").replace(",", "|")
                }), r
            });
        bh.data.ItemRepo.all.filter(function(e) {
            return !r.includes(e.name)
        }).forEach(function(e) {
            return console.log(e.name)
        });
        var a = "guid\tname\tdungeon\tdifficulty\tact\tkeys\tfame\tgold\telementTypes\tcrystals\trunes\tmats\trandomMats\tboosterElementTypes\tboosterRarities";
        n.forEach(function(e) {
            a += "\n" + e.guid + "\t" + e.name + "\t" + e.dungeon + "\t" + e.difficulty + "\t" + e.act + "\t" + e.keys + "\t" + e.fame + "\t" + e.gold + "\t" + e.elementTypes + "\t" + e.crystals + "\t" + e.runes + "\t" + e.mats + "\t" + e.randomMats + "\t" + e.boosterElementTypes + "\t" + e.boosterRarities
        }), $("#data-output").val(a)
    })
}! function(e) {
    ! function(t) {
        function r(e) {
            ...
            return Array.isArray(e) && e.length > 0 && e.forEach(function(e) {
                var r = e[(Object.keys(e) || [])[0] || "0"],
                    a = r[(Object.keys(r) || [])[0] || ""] || null;
                n(a) && t.push(a)
            }), t
        }
        ...
        function a(e) {
            return !!(e && e.playerId && e.archetypeLevels)
        }
        var i;
        t.BattleCardRepo = new e.BattleCardRepo(DataSheetID, BattleCardRepoGID, NO_CACHE), t.BoosterCardRepo = new e.BoosterCardRepo(DataSheetID, BoosterCardRepoGID, USE_CACHE), t.DungeonRepo = new e.DungeonRepo(DataSheetID, DungeonRepoGID, NO_CACHE), t.EffectRepo = new e.EffectRepo(DataSheetID, EffectRepoGID, NO_CACHE), t.HeroRepo = new e.HeroRepo(DataSheetID, HeroRepoGID, USE_CACHE), t.ItemRepo = new e.ItemRepo(DataSheetID, ItemRepoGID, USE_CACHE), t.PlayerRepo = new e.Repo, t.WildCardRepo = new e.Repo(DataSheetID, WildCardRepoGID, USE_CACHE), t.arenaToPlayers = r, t.isGuildWar = function(e) {
            return e && e.guilds && e.currentWar && !0
        }, t.isGuild = function(e) {
            return e && e.playerGuild && e.members && !0
        }, t.isArena = function(e) {
            return r(e).length && !0
        }, t.isPlayer = n, t.isGuildMembers = function(e) {
            return e && Array.isArray(e) && !e.map(a).includes(!1)
        }, t.isGuildPlayer = a, t.init = function() {
            return i || (i = Promise.all([t.guilds.init()].concat(e.Repo.init()))), i
        }
    }(e.data || (e.data = {}))
}(bh || (bh = {})),
function(e) {
    ! function(t) {
        ...
        function i(t, r) {
            var n = a(t, r),
                i = e.ItemRepo.sandsOfTime;
            return n + u(t, r) * e.ItemRepo.getValue(i.itemType, i.rarityType) + [0, 1, 2, 3].map(function(e) {
                return s(t, r, e)
            }).map(function(t, r) {
                return t * e.ItemRepo.getValue(e.ItemType.EvoJar, r)
            }).reduce(function(e, t) {
                return e + t
            }, 0) + c(t, r) * e.ItemRepo.getValue(e.ItemType.Rune, e.RarityType.Rare) + l(t, r) * e.ItemRepo.getValue(e.ItemType.Crystal, e.RarityType.Uncommon)
        }
        ...
        t.getMaxEvo = r, t.evoMultiplier = function(e) {
            return [.8, .85, .88, .9, 1][e]
        }, t.wildsForEvo = n, t.getNextWildCardsNeeded = function(e) {
            return n(e.rarityType, e.evo)
        }, t.getMaxWildCardsNeeded = function(e) {
            for (var t = r(e.rarityType), a = 0, i = e.evo; i < t; i++) a += n(e.rarityType, i);
            return a
        }, t.getBaseGoldNeeded = a, t.getMinGoldNeeded = function(t, r) {
            var n = e.ItemRepo.sandsOfTime;
            return a(t, r) + o(t, r) * e.ItemRepo.getValue(n.itemType, n.rarityType)
        }, t.getMaxGoldNeeded = i, t.calcMaxGoldNeeded = function(e, n) {
            for (var a = 0, o = (t.BattleCardRepo.find(e.configId) || {}).rarityType || 0, u = r(o), s = +n.split(/\./)[0]; s < u; s++) a += i(o, s);
            return a
        }, t.getMinSotNeeded = o, t.getMaxSotNeeded = u, t.calcMaxSotNeeded = function(e, n) {
            for (var a = 0, i = (t.BattleCardRepo.find(e.configId) || {}).rarityType || 0, o = r(i), s = +n.split(/\./)[0]; s < o; s++) a += u(i, s);
            return a
        }, t.getMaxMatNeeded = s, t.getMinCrystalsNeeded = function(t, r) {
            return t == e.RarityType.Legendary && 4 == r ? 30 : 0
        }, t.getMaxCrystalsNeeded = l, t.calcMaxCrystalsNeeded = function(e, n) {
            for (var a = 0, i = (t.BattleCardRepo.find(e.configId) || {}).rarityType || 0, o = r(i), u = +n.split(/\./)[0]; u < o; u++) a += t.getMaxCrystalsNeeded(i, u);
            return a
        }, t.getMinRunesNeeded = function(t, r) {
            return t == e.RarityType.Legendary && 4 == r ? 30 : 0
        }, t.getMaxRunesNeeded = c, t.calcMaxRunesNeeded = function(e, n) {
            for (var a = 0, i = (t.BattleCardRepo.find(e.configId) || {}).rarityType || 0, o = r(i), u = +n.split(/\./)[0]; u < o; u++) a += t.getMaxRunesNeeded(i, u);
            return a
        }
    }(e.data || (e.data = {}))
}(bh || (bh = {})),
function(e) {
    ...
    (function(r) {
        ...
        function o(e) {
            return i.find(function(t) {
                return t && t.playerGuild && t.playerGuild.id == e
            })
        }
        ...
        function l(r, n, u) {
            if (n) {
                ...
                c ? (c.lower = (n || "").toLowerCase(), c.name = n || "", c.parent = c.parent || u || null) : a.push({
                    guid: r,
                    lower: (n || "").toLowerCase(),
                    name: n || null,
                    parent: u || null
                ...
                var d = r[0].guildId,
                    p = s(d),
                    f = p && o(p.guid);
                f ? f.members = r : i.push({
                    playerGuild: {
                        members: r.map(function(e) {
                            return {
                                playerId: e.playerId
                            }
                        }),
                ...
                if (g) {
                    l(g.id, g.name);
                    var h = i.findIndex(function(e) {
                        return e.playerGuild.id == g.id
                    }); - 1 < h ? i[h] = r : i.push(r), y.members.forEach(function(r) {
                        return t.PlayerRepo.put(new e.Player(r))
                    })
                }
            }
        }
        ...
        function c(t) {
            return a = e.Repo.mapTsv(t)
        }
        r.findByGuid = o, r.filterByName = function(e) {
            return u(e).map(function(e) {
                return o(e.guid)
            }).filter(function(e) {
                return !!e
            })
        }, r.filterNamesByName = u, r.filterNamesByParent = function(e) {
            return e && a.filter(function(t) {
                return t.parent === e
            }) || []
        }, r.findNameByGuid = s, r.getNames = function() {
            return a.slice()
        }, r.updateLeaderBoard = function(e) {
            e && e.leaderboardEntries && e.leaderboardEntries.forEach(function(e) {
                var t = s(e.id);
                t || (l(e.id, e.name), t = s(e.id)), t.leaderBoardEntry = e
            })
        }, r.put = l, r.init = function() {
            return n || (n = new Promise(function(t) {
                var r = (e.TSV || {})[String(GuildsGID)];
                r ? t(c(r)) : e.Repo.fetchTsv(DataSheetID, GuildsGID).then(function(e) {
                    return t(c(e))
                }, function() {
                    return t(a)
                })
    ...
    })((t = e.data || (e.data = {})).guilds || (t.guilds = {}))
}(bh || (bh = {})),
function(e) {
    var t;
    (function(r) {
        var n = {};
        r.getReport = function(e) {
            var t = l(e);
            return t[e] || (t = i(e)), t[e] || (t = u(e)), t[e] || (t = n), t
        };
        var a = {};

        function i(e) {
            return a[e] && c(a[e].members) || {}
        }
        r.putGuild = function(e) {
            return e && e.playerGuild ? (a[e.playerGuild.id] = e, i(e.playerGuild.id)) : {}
        }, r.getGuildReport = i;
        var o = {};
        ...
        r.putGuildMembers = function(e) {
            return o[e[0].guildId] = e.slice(), u(e[0].guildId)
        }, r.getGuildMembersReport = u;
        var s = {};
        ...
        function l(r) {
            return s[r] && function(r) {
                t.HeroRepo.sorted;
                var n = r.guilds[0],
                    a = r.guilds.find(function(e) {
                        return e.id != n.id
                    }),
                    i = r.members[n.id].sort(e.utils.sort.byPositionThenName),
                ...
                function c(e, t, n) {
                    var a = d(t, e),
                        i = function(e, t) {
                            ...
                            return t && r.forEach(function(e) {
                                e.initiator.playerId == t.playerId && (e.initiator.winner ? n++ : a++, e.completedBragId && o++, u += e.initiator.totalScore), e.opponent.playerId == t.playerId && (e.opponent.winner && i++, u += e.opponent.totalScore)
                            }), {
                                winCount: n,
                                lossCount: a,
                                dwCount: i,
                    ...
                    return a + "\t" + i.winCount + "\t" + i.lossCount + "\t" + i.dwCount + "\t" + i.brags + "\t" + i.score
                }
            }(s[r]) || {}
        }
        ...
        function c(r) {
            t.HeroRepo.sorted;
            var n = {};
            return n[r[0].guildId] = r.slice().sort(e.utils.sort.byPositionThenName).map(d).join("\n"), n
        }
        ...
        function d(r, n) {
            var a = t.PlayerRepo.find(r.playerId),
                ...
                o = r.fameLevel + 1,
                u = t.HeroRepo.sorted.map(a ? function(t) {
                    var r = a.heroes.find(function(e) {
                            return t.guid == e.guid
                        }),
                        n = r ? r.level : "/",
                        i = r ? e.utils.truncateNumber(r.hitPoints) : "/",
                        o = r && r.isOp ? "Y" : " ",
                        u = r ? r.powerRating + " " : "/";
                    return n + "|" + i + "|" + o + "|" + u
                } : function(t) {
                    var n = r.archetypeLevels[t.guid] + 1,
                        a = e.utils.truncateNumber(t.getHitPoints(n));
                    return n ? n + "|" + a + "|" : "/|/|/|/"
                });
            return [n ? n + 1 : "GL", o, r.name, i].concat(u).join("\t")
        }
        r.putGuildWar = function(e) {
            return e.guilds.forEach(function(t) {
                return s[t.id] = e
            }), l(e.guilds[0].id)
        }, r.getGuildWarReport = l
    })((t = e.data || (e.data = {})).reports || (t.reports = {}))
}(bh || (bh = {})),
function(e) {
    ! function(t) {
        t.addCardTypes = function(t) {
            void 0 === t && (t = e.$());
...
function(e) {
    ...
    function o(e, r) {
        if (!a) return ++i > 60 ? r("60 tries") : void(t && t.jQuery && t.document && t.document.body ? (t.jQuery(function() {
            n.forEach(function(e) {
                return e()
            })
        }), e()) : a || setTimeout(o, 1500, e, r))
    }
    ...
    e.loaded = function(e) {
        return t = t || e, r || (r = new Promise(function(e, t) {
            o(e, t), l(function() {
                e()
            })
        }))
    ...
    function l(e) {
        return e ? "function" != typeof e || t && t.jQuery ? (t && t.jQuery || u)(e) : n.push(e) : t && t.jQuery || u
    }
    e.$ = l,
        function(t) {
            function r(e, t) {
                e && String(t).length && l('.brain-hud-inventory-buttons > button[data-action="toggle-' + e + '"][data-' + e + '="' + t + '"]').toggleClass("active");
                var r = l('.brain-hud-inventory-buttons > [data-action="toggle-element"].active').toArray().map(function(e) {
                        return e.getAttribute("data-element")
                    }),
                    n = l('.brain-hud-inventory-buttons > [data-action="toggle-klass"].active').toArray().map(function(e) {
                        return e.getAttribute("data-klass")
                    }),
                    a = l('.brain-hud-inventory-buttons > [data-action="toggle-type"].active').toArray().map(function(e) {
                        return e.getAttribute("data-type")
                    });
                l("#brain-hud-inventory-items-container > div").hide(), r.length || n.length || a.length ? l("#brain-hud-inventory-items-container > div").each(function(e, t) {
                    var i = l(t),
                        o = !r.length || r.includes(String(i.data("elementType"))),
                        u = !n.length || n.includes(String(i.data("klassType"))) || n.includes(i.data("brag")),
                        s = !a.length || a.includes(i.data("type")) || a.includes(String(i.data("itemType")));
                    o && u && s && i.show()
                }) : l('#brain-hud-inventory-items-container > div[data-hud="true"]').show()
            }

            function n(t) {
                var n, a, i, o, u, s = l(t.target).closest("[data-action]"),
                    c = s.data("action");
                switch (c) {
                    case "hud-to-library":
                        ...
                        break;
                    case "sort-heroes":
                        i = l("div.brain-hud-scouter-player" + (a ? '[data-guid="' + a + '"]' : ".active")), u = (o = ["element-klass", "power-percent-asc", "power-asc", "hp-asc", "name"])[o.indexOf(i.data("sort") || "element-klass") + 1] || "element-klass", i.data("sort", u), a || (a = i.data("guid")), e.data.PlayerRepo.find(a).heroes.sort(function(t, r) {
                            var n, a;
                            if ("power-percent-asc" == u && (n = t.powerPercent) != (a = r.powerPercent)) return n < a ? -1 : 1;
                            if ("power-asc" == u && (n = t.powerRating) != (a = r.powerRating)) return n < a ? -1 : 1;
                            if ("hp-asc" == u) {
                                var i = t.hitPoints,
                                    o = r.hitPoints;
                                if (i != o) return i < o ? -1 : 1
                            }
                            return "name" == u ? e.utils.sort.byName(t, r) : e.utils.sort.byElementThenKlass(t, r)
                        }).forEach(function(e) {
                            return i.find('[data-guid="' + a + "-" + e.guid + '"]').appendTo(i)
                        });
                        break;
                    case "refresh-guild":
                        e.Messenger.instance.postMessage(e.Messenger.createMessage("refresh-guild", l("#brain-hud-scouter-guild-target").val()));
                        break;
                    case "refresh-player":
                        e.Messenger.instance.postMessage(e.Messenger.createMessage("refresh-player", l("#brain-hud-scouter-player-target").val()));
                        break;
                    case "toggle-child":
                        var d = l('div[data-parent-guid="' + (n = s.data("guid")) + '"]').toggleClass("active").hasClass("active");
                        l('button[data-action="toggle-child"][data-guid="' + n + '"]').text(d ? "[-]" : "[+]");
                        break;
                    case "toggle-element":
                        r("element", s.data("element"));
                        break;
                    case "toggle-klass":
                        r("klass", s.data("klass"));
                        break;
                    case "toggle-type":
                        r("type", s.data("type"));
                        break;
                    ...
                    case "toggle-scouter-hero":
                        s.closest("[data-guid]").find(".brain-hud-scouter-panel-content").toggleClass("active");
                        break;
                    ...
                    case "toggle-guild-scouter":
                        var p = l("textarea#brain-hud-scouter-guild-report").toggleClass("active").hasClass("active");
                        l('button.brain-hud-toggle[data-action="toggle-guild-scouter"]').text(p ? "[-]" : "[+]");
                        break;
                    case "toggle-player-scouter":
                        p = l("div#brain-hud-scouter-player-report").toggleClass("active").hasClass("active");
                        l('button.brain-hud-toggle[data-action="toggle-player-scouter"]').text(p ? "[-]" : "[+]");
                        break;
                    case "toggle-inventory":
                        p = l("div.brain-hud-inventory-container").toggleClass("active").hasClass("active");
                        l('button.brain-hud-toggle[data-action="toggle-inventory"]').text(p ? "[-]" : "[+]");
                        break;
                    default:
                        console.log(c)
                }
            ...
            t.init = function() {
                e.data.init().then(function() {
                    l("body").on("click change", "[data-action]", n)
                })
            }, t.toggle = r
        }(e.events || (e.events = {}))
}(bh || (bh = {})),
function(e) {
    ...
    function n() {
        ...
        return t || (t = String(location.href).toLowerCase().includes("battlehand-hud/") ? "." : e.host), t + "/images/" + r.join("/") + ".png"
    }
    e.getImg = function() {
        for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
        return r(n.apply(void 0, e))
    }, e.getImg12 = function() {
        for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
        return r(n.apply(void 0, e), "icon-12")
    }, e.getImg20 = function() {
        for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
        return r(n.apply(void 0, e), "icon-20")
    }, e.getImgG = function() {
        for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
        return r(n.apply(void 0, e), "grayscale")
    }, e.getSrc = n
}(bh || (bh = {})),
function(e) {
    var t;
        ...
        function(r) {
            ...
            function a(t) {
                e.Messenger.isValidMessage(t) ? i.forEach(function(e) {
                    if (e && e.action == t.action && e.callbackfn) try {
                        ...
                        console.error(t.action, e)
                    }
                }) : console.log("invalid message", t)
            }! function(e) {
                var t, r, n = !1,
                    a = !1,
                    i = !1;
                ...
                e.setResolve = function(e, n) {
                    t = e, r = n
                }, e.resolveHud = function() {
                    n = !0, o()
                }, e.resolveListener = function() {
                    a = !0, o()
                }
            }(n || (n = {}));
            var i = [{
            ...
            function u(t) {
                if (t.readyState == XmlHttpRequest.DONE) {
                    ...
                    if (r) {
                        var a = (u = t.requestUrl, (s = i.find(function(e) {
                                return u.includes(e.url)
                            })) && s.action || null),
                            o = {
                                action: a,
                                playerGuid: r[1],
                        ...
                        if (!a) return;
                        n.resolveListener(), e.Messenger.instance.postMessage(o)
                    }
                }
                var u, s
            }
            r.addAction = function(e, t, r) {
                i.push({
                    action: e,
                    url: t,
                    callbackfn: r
                ...
                return void 0 === i && (i = "http://bh.elvenintrigue.com/"), new Promise(function(u, s) {
                    var l = String(r && r.location && r.location.href || "").toLowerCase();
                    e.isLocal = l.includes("battlehand-hud/default.htm") || l.includes("battlehand-hud/iframe.htm"), e.isHud = l.includes("battlehand-hud/default.htm") || l.startsWith("http://www.kongregate.com/games/anotherplaceprod/battlehand-web"), e.isListener = l.includes("battlehand-hud/iframe.htm") || l.startsWith("http://game261051.konggames.com/gamez/"), e.host = i, e.isHud ? (r.bh = e, XmlHttpRequest.attach(r), e.loaded(r).then(function() {
                        e.Messenger.initialize(r, a), e.data.init().then(function() {
                            t.render(), e.Messenger.instance.postMessage(e.Messenger.createMessage("hud-init", "hud-init")), u(r)
                        }, function() {
                            return s("data.init rejected")
                        })
                    }, function(e) {
                        return s("loaded(win) rejected: " + e)
                    })) : e.isListener ? (n.setResolve(r, u), XmlHttpRequest.attach(r, o), e.Messenger.initialize(r, a)) : s("not hud nor listener")
                })
            }, r.handleReadyStateChange = u
        }((t = e.hud || (e.hud = {})).listener || (t.listener = {}))
}(bh || (bh = {})),
function(e) {
    var t;
    (t = e.hud || (e.hud = {})).arena || (t.arena = {}), t.listener.addAction("get-arena-matches", "/v1/matchmaking/getmatches?", function(r) {
...
function(e) {
    ...
    (function(r) {
        function n(t) {
            var r = e.data.guilds.findNameByGuid(t);
            if (!r) return console.log("guildName not found: " + t);
            var n = e.Player.me,
                a = n && n.guildParent || null,
                o = a && e.data.guilds.filterNamesByParent(a) || [],
                u = n && n.canScout,
                s = n && n.guildGuid == t;
        ...
        function a(t) {
            if (t && t.value) {
                var r = t.value,
                    n = e.data.guilds.findNameByGuid(r),
                    a = n && n.leaderBoardEntry || null,
                    i = "" + (a && "#" + (a.rank + 1) + " " || "") + (a && (a.wins || a.losses) && "(" + n.leaderBoardEntry.wins + "/" + n.leaderBoardEntry.losses + ") " || "") + n.name;
                t.text = i
            }
        }
        ...
        function i() {
            ...
            a(e.$('#brain-hud-scouter-guild-target > option[value="' + t + '"]')[0]), e.$("#brain-hud-scouter-guild-report").val(e.data.reports.getReport(t)[t] || "")
        }
        ...
        function o(e, r) {
            return new Promise(function(n, a) {
                var i, o = e.slice();
                ! function e() {
                    (i = o.shift()) ? setTimeout(function() {
                        return u(i.id, r).then(e, e)
                    }, t._delayMS): n()
                }()
            })
        }
        ...
        function u(r, n) {
            ...
            return e.isLocal && (a = "./json/" + r + ".json"), new Promise(function(i, o) {
                return e.Messenger.ActivePlayerGuid && e.Messenger.ActiveSessionKey ? r ? void XmlHttpRequest.getJSON(a).then(function(r) {
                    ...
                    if (e.Messenger.instance.postMessage(e.Messenger.createMessage("get-guild-members", r)), n) {
        ...
        r.addGuildReport = n, r.selectGuildReport = i, t.listener.addAction("get-guild", "/v1/guild/get?", function(t) {
            var r = t.data,
                a = r && r.playerGuild && r.playerGuild.id,
                i = r && r.playerGuild && r.playerGuild.name;
            a && i && (e.data.guilds.put(a, i), e.data.reports.putGuild(r), n(a))
        }), t.listener.addAction("get-guild-members", "/v1/guild/getmembers?", function(t) {
            var r = t.data,
                a = r[0].guildId;
            e.data.reports.putGuildMembers(r), n(a)
        }), t.listener.addAction("get-guild-war", "/v1/guildwars/get?", function(t) {
            var r = t.data;
        ...
        }), t.listener.addAction("get-leaderboard", "/v1/guildwars/getrange?", function(t) {
            var r = t.data;
            e.data.guilds.updateLeaderBoard(r), e.$("#brain-hud-scouter-guild-target").children().toArray().forEach(a)
        }), t.listener.addAction("get-guildsearch", "/v1/guild/getguilds?", function(t) {
            t.data.forEach(function(t) {
                return e.data.guilds.put(t.id, t.name)
            })
        }), t.listener.addAction("get-leaderboard-members", "/v1/guildwars/getguildmembersrange?", function(e) {
            n(e.guildGuid)
        }), r.searchGuilds = function(t, r) {
            var n = "https://battlehand-game-kong.anotherplacegames.com/v1/guild/getguilds?player=" + e.Messenger.ActivePlayerGuid + "&sessionKey=" + e.Messenger.ActiveSessionKey + "&name=" + t + "&joinableonly=False&language=&minfamelevel=2&maxfamelevel=44";
            return new Promise(function(t, a) {
                if (!e.Messenger.ActivePlayerGuid || !e.Messenger.ActiveSessionKey) return a("not initialized");
                XmlHttpRequest.getJSON(n).then(function(e) {
                    if (!e || !Array.isArray(e)) return a("invalid json");
                    o(e, r).then(t, a)
                }, a)
            })
        }, r.guildsGetMembers = o, r.guildGetMembers = u, r.leaderBoardGet = function(t, r) {
            void 0 === t && (t = 0), void 0 === r && (r = 13);
            ...
            return e.isLocal && (n = "./json/top_guilds.json"), new Promise(function(t, r) {
                ...
                XmlHttpRequest.getJSON(n).then(function(n) {
                    ...
                    e.Messenger.instance.postMessage(e.Messenger.createMessage("get-leaderboard", n)), t(n)
                }, r)
            })
        }, t.listener.addAction("refresh-guild", null, function(e) {
            u(e.data, !0)
        })
    })((t = e.hud || (e.hud = {})).guild || (t.guild = {}))
}(bh || (bh = {})),
function(e) {
    var t;
    (t = e.hud || (e.hud = {}))._delayMS = 500,
        function(r) {
            function n(t) {
            ...
            function a(r) {
                var a = r.data,
                    o = new e.Player(a),
                    u = e.$("#brain-hud-scouter-player-target");
                if (e.$('#brain-hud-scouter-player-target > option[value="' + o.guid + '"]').length || (u.append('<option value="' + o.guid + '">' + (o.isFullMeat ? "&#9734; " : "") + e.utils.htmlFriendly(o.name) + "</option>"), u.children().toArray().slice(1).sort(function(e, t) {
                        return e.text < t.text ? -1 : e.text == t.text ? 0 : 1
                    }).forEach(function(e) {
                        return u.append(e)
                    ...
                    n(o);
                    var s = o.guilds;
                    s.length && t.guild.addGuildReport && s.forEach(function(e) {
                        return t.guild.addGuildReport(e.guid)
                    })
                }
                u.val(a.id), i(), t.guild.selectGuildReport()
            }

            function i() {
                e.$("div.brain-hud-scouter-player-container").addClass("active"), e.$("#brain-hud-scouter-player-report").show(), e.$("div.brain-hud-scouter-player").removeClass("active");
            ...
            function o(t) {
                ...
                return e.isLocal && (r = "./json/" + t + ".json"), new Promise(function(n, a) {
                    return e.Messenger.ActivePlayerGuid && e.Messenger.ActiveSessionKey ? t ? void XmlHttpRequest.getJSON(r).then(function(t) {
                        ...
                        e.Messenger.instance.postMessage(e.Messenger.createMessage("get-player", t)), n(t)
                    }, a) : a("no player id") : a("not initialized")
                })
            }
            r.loadPlayer = n, r.addPlayerReport = a, r.selectPlayerReport = i, t.listener.addAction("get-player", "/v1/player/get?", a), t.listener.addAction("get-player", "/v1/player/getplayerinfo?", a), r.playersGet = function(e) {
                return new Promise(function(r, n) {
                    var a, i = e.slice();
                    ! function e() {
                        (a = i.shift()) ? setTimeout(function() {
                            return o(a).then(e, e)
                        }, t._delayMS): r()
                    }()
                })
            }, r.playerGet = o, t.listener.addAction("refresh-player", null, function(e) {
                o(e.data)
            })
        }(t.player || (t.player = {}))
}(bh || (bh = {})),
function(e) {
    ! function(e) {
        e.getFromStorage = function(e) {
            ...
            for (var r = new RegExp("\\w+"), n = e.match(new RegExp("#{\\w+}", "g")), a = 0, i = n.length; a < i; a++) n[a] = n[a].match(r)[0];
            var o = e;
            for (a = 0, i = n.length; a < i; a++)
                for (var u = n[a], s = 0, l = t.length; s < l; s++) {
                    var c = t[s];
                    if (u in c) {
                        o = o.replace("#{" + u + "}", c[u]);
                        break
            ...
            for (var t = String(e).split(""), r = [], n = 0, a = t.length; a--;) r.length && n % 3 == 0 && r.unshift(","), r.unshift(t.pop()), n++;
            return r.join("")
        }, e.round = function(e, t) {
            var r = 10 ^ t,
                n = e * r;
            return Math.round(n) / r
        }, e.truncateNumber = function(t) {
            var r = e.formatNumber(t),
                n = r.split(",");
            ...
            return "y" === r || "t" === r || "1" === t
        }, e.evoToStars = function(e, t) {
            void 0 === t && (t = String(e + 1));
            for (var r = +t.split(".")[0], n = e + 1, a = 0, i = ""; r--;) a++, i += "<span class='evo-star'>&#9733;</span>";
        ...
        var t = {};
        e.logMissingCard = function(e) {
            t[e.playerCard.id] || (console.log("Missing BattleCard:", e.name + ": " + e.playerCard.id + " (" + e.evoLevel + ")"), t[e.playerCard.id] = !0)
        }, e.asyncForEach = function(e, t, r) {
            return new Promise(function(n, a) {
                var i = e.map(function(e, n, i) {
                        return function(e, n, i) {
                            setTimeout(function(e, r, n, i) {
                                try {
                                    var u = t.call(e, r, n, i);
                                    u instanceof Promise ? u.then(o, a) : o()
                                } catch (e) {
                                    a(e)
                                }
                            }, 0, r, e, n, i)
...
function(e) {
    ...
    t = e.hud || (e.hud = {}),
        function(r) {
            function n(t, r) {
                void 0 === r && (r = -1);
                var n, a = t.isFullMeat,
                    i = a ? "&#9734;" : "",
                    o = t.isArena || a ? "" : ' <span style="white-space:nowrap;">(' + t.completionPercent + "%)</span>",
                    u = '<div class="player-name" data-action="sort-heroes">' + i + " " + e.utils.htmlFriendly(t.name) + " " + o + "</div>";
                t.heroes.sort(e.utils.sort.byElementThenKlass).forEach(function(r) {
                    if (t.isMe || !r.isLocked) {
                        var n, a, i, o, s, l, c = t.guid + "-" + r.guid,
                            d = r.isLocked ? e.getImg("misc", "Lock") : e.getImg("heroes", r.name),
                            p = r.isLocked ? "" : r.level == e.HeroRepo.MaxLevel ? r.isMeat ? '<span class="evo-star">&#9734;</span>' : '<span class="star">&#9734;</span>' : "(" + r.level + ")",
                            f = r.isLocked ? "" : e.utils.truncateNumber(r.hitPoints) + " HP",
                            y = r.hero.maxPowerThresholds,
                            g = r.powerRating,
                            h = Math.round(100 * g / y[g < y[3] ? 3 : 4]),
                            m = r.isOp ? "background-color:pink;" : "",
                            b = g <= y[0] ? "progress-bar-info" : g <= y[1] ? "progress-bar-success" : g <= y[2] ? "progress-bar-warning" : "progress-bar-danger",
                            v = r.isLocked ? "" : '<div class="progress" style="' + m + '"><div class="progress-bar ' + b + '" style="width:' + h + '%;"><span></span></div></div>',
                            T = r.isLocked ? "" : g,
                            R = '<span class="hero-icon">' + d + '</span><span class="hero-name">' + r.name + '</span><span class="hero-level">' + p + '</span><span class="hero-hp">' + f + '</span><span class="hero-rating-bar">' + v + '</span><span class="hero-rating">' + T + '</span><span class="hero-max"> ' + y[4] + "</span>",
                            C = "";
                        if (t.isMe || t.isAlly) {
                            var P = r.playerHeroAbilities.map(function(t) {
                                ...
                                x = r.deck.map(function(e) {
                                    return e.rowHtml
                                }).join("");
                            C = "" + P.join("") + x
                        }
                        u += (n = c, a = r.elementType, i = R, o = C, s = t.isMe || t.isAlly, l = '<button class="bs-btn bs-btn-link bs-btn-sm ' + e.ElementType[a] + '" ' + (s ? 'data-action="toggle-scouter-hero"' : "") + ">" + i + "</button>", '<div class="brain-hud-scouter-panel" data-guid="' + n + '"><div class="brain-hud-scouter-panel-header">' + l + '</div><div class="brain-hud-scouter-panel-content">' + o + "</div></div>")
                    }
                }), (n = -1 == r ? t.guid : "arena-" + r, e.$('div.brain-hud-scouter-player[data-guid="' + n + '"]').length || e.$("div#brain-hud-scouter-player-report").append('<div class="brain-hud-scouter-player" data-guid="' + n + '"></div>'), e.$('div.brain-hud-scouter-player[data-guid="' + n + '"]')).html(u)
            }(t.scouter || (t.scouter = {})).loadPlayer = n
        }()
}(bh || (bh = {})),
function(e) {
    ! function(t) {
        var r, n, a = window.jQuery,
            i = null;
        ...
        function u(t, n) {
            void 0 === n && (n = null);
            var a = e.Messenger.createMessage(t, {
                action: t,
                data: n
            });
            a.playerGuid = t, a.sessionKey = t, r.postMessage(a)
        }

        function s(t) {
            var r = t.data || t.originalEvent && t.originalEvent.data || null;
            r && ("hud-sending-player" == r.action && r.data && (i = new e.Player(r.data), l()), "library-requesting-player" == r.action && u("hud-sending-player", e.Player.me._pp))
        }

        function l() {
            e.host = "http://bh.elvenintrigue.com", e.data.init().then(I), a("body").on("click", '[data-action="show-card"]', h), a("body").on("click", '[data-action="show-item"]', g), a("body").on("click", "[data-search-term]", c), a("input.library-search").on("change keyup", T), a("button.library-search-clear").on("click", d), a("input[type='range']").on("change input", p);
            var t = a("#card-evolution div.tab-pane"),
                r = t.html();
            t.html(r).toArray().forEach(function(e, t) {
                return a(e).find("h3").text("Evolution from " + t + " to " + (t + 1))
            })
        }

        function c(e) {
            var t = a(e.target).closest("[data-search-term]").attr("data-search-term"),
                r = t.toLowerCase(),
                n = a("input.library-search"),
                i = n.val();
            i.trim().toLowerCase().split(/\s+/).includes(r) || (n.focus().val((i + " " + t).trim()).blur(), R((i + " " + t).trim().toLowerCase()))
        }

        function d() {
            b = null, a("input.library-search").val(""), a('a[href="#card-table"] > span.badge').text(String(e.data.BattleCardRepo.length)), a('a[href="#effect-table"] > span.badge').text(String(e.data.EffectRepo.length)), a('a[href="#item-table"] > span.badge').text(String(e.data.ItemRepo.length)), a("tbody > tr[id]").show()
        }

        function p(t) {
            var r = a("#card-slider-evo").val(),
                i = a("#card-slider-level").val();
            a(t.target).closest("input[data-action]").data("action");
            a("#card-slider-types").html('<span style="padding-left:25px;">' + r + "." + ("0" + i).substr(-2) + "</span><br/>" + n.typesTargets.map(function(t, n) {
                return e.getImg20("cardtypes", t.split(" ")[0].replace("Damage", "Attack")) + " " + t + " (" + e.utils.formatNumber(f(n, r, i)) + ")"
            }).join("<br/>"))
        }
        ...
        function f(t, r, a) {
            ...
            return e.BattleCardRepo.calculateValue(i, t)
        }
        ...
        function g(t) {
            var r = a(t.target).closest("tr").attr("id"),
                n = e.data.ItemRepo.find(r);
            n, a("div.modal-item").modal("show"), a("#item-name").html(n.name + " &nbsp; " + k([n.name]).join(" ")), a("#item-rarity").html(e.utils.evoToStars(n.rarityType) + " " + e.RarityType[n.rarityType]), a("#item-element").html(e.ElementRepo.toImage(n.elementType) + " " + e.ElementType[n.elementType]);
            var i = e.data.DungeonRepo.getDropRates(n.name).map(function(e) {
                return "<tr><td>" + e.dungeon.name + "</td><td>" + e.dungeon.keys + " keys</td><td>" + Math.round(1e3 * e.dropRate.averagePerKey) / 10 + "% / key</td></tr>"
            }).join("");
            a("#item-dungeons").html('<table class="table table-striped table-condensed"><tbody>' + i + "</tbody></table>")
        }

        function h(t) {
            var r = a(t.target).closest("tr").attr("id"),
                i = e.data.BattleCardRepo.find(r);
            n = i, a("div.modal-card").modal("show"), a("#card-name").html(i.name + " &nbsp; " + O(i).join(" ")), a("#card-image").attr("src", e.getSrc("battlecards", "blank", o(i.name))), a("#card-element").html(e.ElementRepo.toImage(i.elementType) + " " + e.ElementType[i.elementType]), a("#card-klass").html(e.KlassRepo.toImage(i.klassType) + " " + e.KlassType[i.klassType]), a("#card-klass").removeClass("Magic Might Skill").addClass(e.KlassType[i.klassType]), a("#card-rarity").html(e.utils.evoToStars(i.rarityType) + " " + e.RarityType[i.rarityType]), a("#card-types").html(i.typesTargets.map(function(t, r) {
                return e.getImg20("cardtypes", t.split(" ")[0].replace("Damage", "Attack")) + " " + t.split(" ")[0].replace("Damage", "Attack") + " (" + e.utils.formatNumber(y(r)) + " - " + e.utils.formatNumber(f(r, n.rarityType + 1, e.BattleCardRepo.getLevelsForRarity(n.rarityType) - 1)) + ")"
            }).join("<br/>")), a("#card-turns").html(String(i.turns)), a("div.panel-card span.card-brag").html(String(i.brag)), a("div.panel-card span.card-min").html(i.minValues.map(function(e) {
                return e.join()
            }).join(" :: ")), a("div.panel-card span.card-max").html(i.maxValues.join(" :: ")), a("div.panel-card span.card-mats").html(i.mats.join()), a("#card-targets").html(e.EffectRepo.mapTargets(i).map(function(t) {
                return e.EffectRepo.toImage(t) + " " + t.name + "<br/>"
            }).join("")), a("#card-effects").html(e.EffectRepo.mapEffects(i).map(function(t) {
                return e.EffectRepo.toImage(t) + " " + t.name + "<br/>"
            }).join("")), a("#card-perks").html(e.EffectRepo.mapPerks(i).map(function(t) {
                return e.EffectRepo.toImage(t) + " " + t.name
            }).join("<br/>")), a("div.panel-card span.card-perk").html(i.perkBase + "%"), a("#card-mats").html(i.mats.map(function(t) {
                return e.data.ItemRepo.find(t)
            }).map(function(t) {
                return e.ItemRepo.toImage(t) + " " + t.name
            }).join("<br/>"));
            var u = new e.Recipe(i),
                s = 0,
                l = 0,
                c = a("#card-evolution > ul.nav > li").toArray();
            [0, 1, 2, 3, 4].forEach(function(t) {
                var r = u.evos[t],
                    n = "#evo-" + t + "-" + (t + 1),
                    d = a(c[t]).removeClass("disabled");
                if (!r) return a(n + " tbody").html(""), void d.addClass("disabled");
                var p = "",
                    f = e.data.getMinGoldNeeded(i.rarityType, r.evoFrom),
                    y = e.data.getMaxGoldNeeded(i.rarityType, r.evoFrom);
                if (s += f, l += y, p += m(e.getImg("misc", "Coin"), "Gold", f, y), r.items.filter(function(e) {
                        return !!e.max
                    }).forEach(function(t) {
                        return p += m(e.getImg20("evojars", o(t.item.name)), t.item.name, t.min, t.max)
                    }), 5 == r.evoTo) {
                    var g = e.data.ItemRepo.crystals.find(function(e) {
                            return e.elementType == i.elementType
                        }),
                        h = e.data.HeroRepo.all.find(function(e) {
                            return e.elementType == i.elementType && e.klassType == i.klassType
                        }),
                        b = e.data.ItemRepo.runes.find(function(e) {
                            return e.name.startsWith(h.name)
                        });
                    p += m(e.getImg20("crystals", e.ElementType[i.elementType]), g.name, e.data.getMinCrystalsNeeded(i.rarityType, r.evoFrom), e.data.getMaxCrystalsNeeded(i.rarityType, r.evoFrom)), p += m(e.getImg20("runes", o(h.trait.name)), b.name, e.data.getMinRunesNeeded(i.rarityType, r.evoFrom), e.data.getMaxRunesNeeded(i.rarityType, r.evoFrom))
                }
                a(n + " tbody").html(p)
            });
            u.all;
            var d = a("#evo-all tbody").html("");
            if (d.append(m(e.getImg("misc", "Coin"), "Gold", s, l)), u.all.forEach(function(t) {
                    d.append(m(e.getImg20("evojars", o(t.item.name)), t.item.name, t.min, t.max))
                }), i.rarityType == e.RarityType.Legendary) {
                var p = e.data.ItemRepo.crystals.find(function(e) {
                        return e.elementType == i.elementType
                    }),
                    g = e.data.HeroRepo.all.find(function(e) {
                        return e.elementType == i.elementType && e.klassType == i.klassType
                    }),
                    h = e.data.ItemRepo.runes.find(function(e) {
                        return e.name.startsWith(g.name)
                    });
                d.append(m(e.getImg20("crystals", e.ElementType[i.elementType]), p.name, e.data.getMinCrystalsNeeded(i.rarityType, 0), e.data.getMaxCrystalsNeeded(i.rarityType, 4))), d.append(m(e.getImg20("runes", o(g.trait.name)), h.name, e.data.getMinRunesNeeded(i.rarityType, 0), e.data.getMaxRunesNeeded(i.rarityType, 4)))
            }
            a("#card-evolution .active").removeClass("active"), a("#card-evolution > ul.nav > li").first().addClass("active"), a("#card-evolution > div.tab-content > div.tab-pane").first().addClass("active"), a("#card-slider-evo").val(0).attr("max", i.rarityType + 1), a("#card-slider-evo-labels-table tbody").html(new Array(i.rarityType + 2).fill(1).map(function(e, t) {
                return '<td class="text-' + (t ? t == i.rarityType + 1 ? "right" : "center" : "left") + '">' + t + "</td>"
            }).join(""));
            var b = e.BattleCardRepo.getLevelsForRarity(i.rarityType),
                v = 10 == b ? [1, 5, 10] : 20 == b ? [1, 5, 10, 15, 20] : 35 == b ? [1, 5, 10, 15, 20, 25, 30, 35] : [1, 10, 20, 30, 40, 50];
            a("#card-slider-level").val(1).attr("max", b), a("#card-slider-level-labels-table tbody").html(v.map(function(e, t) {
                return '<td class="text-' + (t ? t == v.length - 1 ? "right" : "center" : "left") + '">' + e + "</td>"
            }).join("")), a("#card-slider-types").html('<span style="padding-left:25px;">0.01</span><br/>' + i.typesTargets.map(function(t, r) {
        ...
        t.openLibraryFromHud = function() {
            r = new e.Messenger(window, s, window.open(e.host + "/cards.html?hud,complete", "bh-hud-library", "", !0))
        }, t.init = function() {
            location.search.includes("hud") ? (r = new e.Messenger(window, s, window.opener), u("library-requesting-player")) : l()
        }, t.handleLibraryMessage = s;
        var b, v = {
            card: {},
            effect: {},
            item: {},
        ...
        function T(e) {
            R(a(e.target).val().trim().toLowerCase())
        }

        function R(t) {
            if (!t) return d();
            b = t, ["card", "effect", "item", "dungeon"].forEach(function(r) {
                return setTimeout(function(t) {
                    ! function(t, r) {
                        if (!v[t][r]) {
                            var n = r.split(/\s+/);
                            v[t][r] = C(t).filter(function(r) {
                                return !n.find(function(n) {
                                    return ! function(t, r, n) {
                                        if ("effect" == t) return M(r, n);
                                        E || (E = e.data.HeroRepo.all.map(function(e) {
                                            return e.lower
                                        }));
                                        return x.includes(n) || w.includes(n) || E.includes(n) ? (a = r, i = n, a.find(function(e) {
                                            return e == i
                                        })) : M(r, n);
                                        var a, i
                                    }(t, P[r.guid] || [], n)
                        ...
                        var i = a('a[href="#' + t + '-table"] > span.badge'),
                            o = v[t][r] || [],
                            u = C(t).map(function(e) {
                                return e.guid
                            }).filter(function(e) {
                                return !o.includes(e)
                            });
                        if (r != b) return;
                        a("#" + o.join(",#")).show(), a("#" + u.join(",#")).hide(), i.text(String(o.length))
                    }(r, t)
                }, 0, t)
            })
        }
        ...
        var P = {};
        var x = e.ElementRepo.allTypes.map(function(t) {
                return e.ElementType[t].toLowerCase()
            }),
            w = e.RarityRepo.allTypes.map(function(t) {
        ...
        function j(t) {
            return (r = t, n = [], e.EffectRepo.mapTargets(r).forEach(function(e) {
                return n.includes(e) ? void 0 : n.push(e)
            }), e.EffectRepo.mapEffects(r).forEach(function(e) {
                return n.includes(e) ? void 0 : n.push(e)
            }), e.EffectRepo.mapPerks(r).forEach(function(e) {
                return n.includes(e) ? void 0 : n.push(e)
            }), n.reduce(function(e, t) {
                return ["Self", "Single"].includes(t.name) ? e : e.concat([t])
            }, [])).map(function(e) {
                return A(e.guid, e.name.replace("Splash Damage", "Splash").replace("Multi-Target (Ally)", "Multi").replace("Multi-Target (Enemy)", "Multi"), e.name + ": " + e.description)
            });
            var r, n
        }
        ...
        function k(t) {
            return t.map(function(t) {
                ...
                return A(t.guid, t.name, t.name + ": " + e.RarityType[t.rarityType] + " " + e.ElementType[t.elementType] + " " + e.ItemType[t.itemType] + " (" + e.utils.formatNumber(e.ItemRepo.getValue(t.itemType, t.rarityType)) + " gold)")
            })
        }
        ...
        function O(t) {
            return e.data.HeroRepo.all.filter(function(r) {
                ...
                return A(t.guid, t.name, t.name + ": " + e.ElementType[t.elementType] + " " + e.KlassType[t.klassType] + " Hero")
            })
        }
        ...
        function I() {
            e.css.addCardTypes(a), e.css.addEffects(a), e.css.addElements(a), e.css.addHeroes(a), e.css.addItems(a), e.css.addKlasses(a),
                function() {
                    var t = e.data.EffectRepo.all;
                    a('a[href="#effect-table"] > span.badge').text(String(t.length));
                    var r = a("table.effect-list > tbody");
                    t.forEach(function(e) {
                        ...
                        var t = '<tr id="' + e.guid + '">';
                        t += '<td><div class="bh-hud-image img-' + e.guid + '"></div></td>', t += '<td><span class="card-name">' + e.name + '</span><div class="visible-xs-block" style="border-top:1px dotted #666;">' + e.description + "</div></td>", t += '<td class="hidden-xs" style="width:100%;"><span class="card-description">' + e.description + "</span></td>", t += "</td></tr>", r.append(t)
                    })
                }(),
                function() {
                    var t = e.data.ItemRepo.all;
                    a('a[href="#item-table"] > span.badge').text(String(t.length));
                    var r = a("table.mat-list > tbody");
                    t.forEach(function(t) {
                        var n = i && i.inventory.find(function(e) {
                        ...
                        var a = '<tr id="' + t.guid + '">';
                        a += '<td><div class="bh-hud-image img-' + t.guid + '"></div></td>', a += '<td><span class="card-name"><a class="btn btn-link" data-action="show-item" style="padding:0;">' + t.name + "</a></span></td>", a += "<td>" + H(t.rarityType) + "</td>", i && (a += '<td><span class="badge">' + e.utils.formatNumber(n && n.count || 0) + "</span></td>"), a += '<td class="hidden-xs" style="width:100%;"></td>', a += "</td></tr>", r.append(a)
                    })
                }(),
                function() {
                    var t = location.search.includes("complete"),
                        r = e.data.BattleCardRepo.all;
                    a('a[href="#card-table"] > span.badge').text(String(r.length));
                    var n = a("table.card-list > tbody").html("");
                    r.forEach(function(r) {
                        ! function(t) {
                            if (!P[t.guid]) {
                                ...
                                }), i && r.push(i.battleCards.find(function(e) {
                                    return e.guid == t.guid
                                }) ? "have" : "need")
                            }
                            P[t.guid]
                        }(r);
                        var a = i && i.battleCards.find(function(e) {
                                return r.guid == e.guid
                            }),
                            o = '<tr id="' + r.guid + '">';
                        i && (o += '<td><span class="card-owned glyphicon ' + (a ? "glyphicon-ok text-success" : "glyphicon-remove text-danger") + '" title="' + (a ? "Have" : "Need") + '" data-toggle="tooltip" data-placement="top"></span></td>'), o += '<td><div class="bh-hud-image img-' + (r.brag ? "Brag" : "BattleCard") + '" title="' + (r.brag ? "Brag" : "BattleCard") + '" data-toggle="tooltip" data-placement="top"></div></td>', o += '<td><span class="card-name"><a class="btn btn-link" data-action="show-card" style="padding:0;">' + r.name + "</a></span></td>", o += '<td class="text-center"><span class="card-rating">' + e.utils.formatNumber(e.PowerRating.rateBattleCard(r, e.MinMaxType.Max)) + "</span></td>", t && (o += '<td class="text-center" data-search-term="' + e.RarityType[r.rarityType] + '">' + H(r.rarityType) + "</td>"), t && (o += "<td>" + A(e.ElementType[r.elementType]) + "</td>"), t && (o += "<td>" + A(e.KlassType[r.klassType], void 0, void 0, !0) + "</td>"), o += "<td>" + O(r).join("") + "</td>", t && (o += '<td class="hidden-xs">' + j(r).join("") + "</td>"), t && (o += '<td class="hidden-xs">' + k(r.mats).join("") + "</td>"), o += '<td class="hidden-xs" style="width:100%;"></td>', o += "</td></tr>", n.append(o)
                    })
                }(),
                function() {
                    var t = e.data.DungeonRepo.all;
                    a('a[href="#dungeon-table"] > span.badge').text(String(t.length));
                    var r = a("table.dungeon-list > tbody");
                    t.forEach(function(t) {
                        ! function(e) {
                            if (!P[e.guid]) {
                                var t = P[e.guid] = [];
                        ...
                        var n = '<tr id="' + t.guid + '">';
                        n += '<td><span class="">' + t.name + "</span></td>", n += '<td><span class="">' + e.getImg20("keys", "SilverKey") + " " + t.keys + "</span></td>", n += '<td><span class="">' + e.getImg20("misc", "Fame") + " " + e.utils.formatNumber(t.fame) + "</span></td>", n += '<td><span class="">' + e.getImg20("keys", "RaidTicket") + "</span></td>", n += '<td><span class="">' + e.getImg20("misc", "Coin") + " " + e.utils.formatNumber(t.gold) + " <small>(" + e.utils.formatNumber(Math.round(t.gold / t.keys)) + " / key)</small></span></td>";
                        try {
                            n += '<td><span class="">' + t.elementTypes.map(function(t) {
                                return '<div class="bh-hud-image img-' + e.ElementType[t] + '"></div>'
                            }).join("") + "</span></td>", n += "<td/>", n += "<td/>", n += "<td><span>" + k(t.mats.map(function(e) {
                                return e.name
                            })).join("") + "</span></td>", n += '<td><span class="">' + t.randomMats.map(function(t, r) {
                                return t ? e.getImg20("evojars", "random", e.RarityType[r] + "_Neutral_Small") + t : ""
                            }).join(" ") + "</span></td>"
                        } catch (e) {
                            console.error(e)
                        }
                        n += '<td class="hidden-xs" style="width:100%;"></td>', n += "</td></tr>", r.append(n)
                    })
                }(), a("div.row.alert-row").remove(), a("div.row.table-row").show(), a('[data-toggle="tooltip"]').tooltip()
        }
...
function(e) {
    ...
    (function(t) {
        ...
        function i(e, t) {
            var r = e.lower || e.name.toLowerCase(),
                n = e.lower || t.name.toLowerCase();
            return "sands of time" == r ? -1 : "sands of time" == n ? 1 : r == n ? 0 : r < n ? -1 : 1
        }

        function o(t, r) {
            var n = e.PositionType[t.position],
        ...
        t.byElement = r, t.byElementThenKlass = function(e, t) {
            return r(e, t) || n(e, t)
        }, t.byElementThenName = function(e, t) {
            return r(e, t) || i(e, t)
        }, t.byElementThenRarityThenName = function(e, t) {
            return r(e, t) || s(e, t)
        }, t.byKlass = n, t.byEvoLevel = a, t.byEvoLevelThenName = function(e, t) {
            return a(e, t) || i(e, t)
        }, t.byName = i, t.byPosition = o, t.byPositionThenName = function(e, t) {
            return o(e, t) || i(e, t)
        }, t.byRarity = u, t.byRarityThenName = s, t.byRarityThenNameThenEvoLevel = function(e, t) {
            return u(e, t) || i(e, t) || a(e, t)
        }
    })((t = e.utils || (e.utils = {})).sort || (t.sort = {}))
}(bh || (bh = {}));
var XmlHttpRequest = function() {
    ...
    return Object.defineProperty(e.prototype, "onabort", {
        ...
        try {
            for (var t = [], r = 0, n = e.length; r < n; r += 32768) t.push(String.fromCharCode.apply(null, e.subarray(r, r + 32768)));
        ...
        try {
            for (var r = unescape(encodeURIComponent(e)).split(""), n = [], a = r.length; a--;) n[a] = r[a].charCodeAt(0);
            return new t(n)
        } catch (e) {
